...
{
  std::cout << "[odrive_hardware_interface.cpp] Startup";
  ...
  std::cout << "[odrive_hardware_interface.cpp] pre initialization: odrive = new ODriveUSB()";
  odrive = new ODriveUSB();
  CHECK(odrive->init(serial_numbers_));
  std::cout << "[odrive_hardware_interface.cpp] post initialization: CHECK(odrive->init(serial_numbers_))";
